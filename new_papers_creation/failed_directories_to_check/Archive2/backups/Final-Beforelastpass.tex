...
\scriptsize
    ...
    \begin{tabular}{|c|c|c||c|c|c||c|c|c|}
         ...
         H & Time & Value & H & Time & Value & Avg & Time & Value \\
         \hline
          & 25.95 & 0 & 5 & 3537.67 & 438.95 & 15 & \textbf{1.99} & \textbf{568.20} \\
         \hline
         \hline
...
% \eliran{on BPPEN-13221, GMAA-ICE managed to produce result for higher horizon than in the original problem (5 instead of 4). This is the result I mailed you about, as I didn't manage to reproduce it and it is really close to the time limit, so I'm not sure it is valid}
