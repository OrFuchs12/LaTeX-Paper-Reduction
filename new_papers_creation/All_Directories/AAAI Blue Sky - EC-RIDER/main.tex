...
% For /Title, add Title in Mixed Case. No accents or commands. Retain the parentheses.
 \pdfinfo{
/Title (AI for Explaining Optimization)
/Author (Sarit Kraus, Amos Azaria, Jelena Fiosina, Maike Greve, Noam Hazon, Lutz Kolbe, Tim-Benjamin Lembcke, Jörg P. Müller, Sören Schleibaum, Mark Vollrath)
} %Leave this	
% /Title ()
...
\ac{XAI} has recently been studied extensively~\cite{core2006building,carvalho2019machine,rosenfeld2019explainability}, %Amos: removed zhang2018interpretable,sheh2017did,samek2017explainable due to lack of space
...
%The focus of this paper does not cover how to get explanations from an AI-based decision system, which is %considered the main problem of conventional explainable AI (Ref. to \ac{XAI}). Since producing explanations %sometimes is not an easy task which can be very time consuming (Ref. to time consuming \ac{XAI}) and not %appropriate for real-time systems, the aim of this study is to choose the explanations, which are really %informative to the users, reducing the set of all possible explanations.
...
% XAI that was evaluated with humans
