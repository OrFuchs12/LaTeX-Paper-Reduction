...
%\begin{figure}[t]
%  \centering
%  \subfloat[]{\includegraphics[width=3.6cm,height=1.3cm]{./figures1/fig1a.png}
 %   \label{fig:mapping structure_example_a}}\\
  %\hspace{3.2mm}
%  \subfloat[]{\includegraphics[width=8.0cm,height=4.8cm]{./figures1/fig1b.png}
