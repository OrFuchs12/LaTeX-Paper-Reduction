...
% F /Auth, add all auths within the parentheses, separated by commas. No accents  commands.
% F /Title, add Title in Mixed Case. No accents  commands. Retain the parentheses.
% /Title ()
% Put your actual complete title (no codes, scripts, shtcuts,  LaTeX commands) within the parentheses in mixed case
% Leave the space between \Title and the beginning parenthesis alone
% /Auth ()
% Put your actual complete list of auths (no codes, scripts, shtcuts,  LaTeX commands) within the parentheses in mixed case.
% Each auth should be only by a comma. If the name contains accents, remove them. If there are any LaTeX commands,
% remove them.
