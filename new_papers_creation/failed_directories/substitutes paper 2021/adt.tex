...
Different  input formats exist that allow  voters to express their preferences over    projects, such as approval voting, knapsack ranking and additive utility (specified later on). %\cite{aziz2020participatory,goel2016knapsack, benade2020preference,peters2020proportional}. 
% \cite{aziz2020participatory,goel2016knapsack,aziz2020expanding, benade2020preference,peters2020proportional}. 
...
\begin{definition}[T-cohesive group~\cite{peters2020proportional}] Given a group of voters $S\subseteq V$ and set of projects $T\subseteq A$, we say that group $S$ is T-cohesive if $\frac{L}{|V|}|S|\geq cost(T)$ and $T\subseteq \cap_{i\in S}A(i)$.
...
% SRX holds SPR if $\forall i\in V, \forall g\in v_i, u_{i,g}(k)>0$ for all $k\geq 0$.
% \end{theorem}
