...
\caption{\modelname with Spatial (\textbf{S}), Temporal (\textbf{T}), and Spatial and Temporal (\textbf{ST}) relations, the customized set of Filtered relations (\textbf{F}) mentioned in Table \ref{tab:relations}, \textbf{F} without the spatial/temporal relations (\textbf{F-ST}) and \textbf{All} relation types.}
