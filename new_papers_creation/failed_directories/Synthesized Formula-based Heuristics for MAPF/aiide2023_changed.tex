%File: formatting-instrutions-latex-223.tex
%release 223.
\doumentlass[letterpaper]{artile} % DO NOT CHANGE THIS
\usepakage{aaai23}  % DO NOT CHANGE THIS
\usepakage{times}  % DO NOT CHANGE THIS
\usepakage{helvet}  % DO NOT CHANGE THIS
\usepakage{ourier}  % DO NOT CHANGE THIS
\usepakage[hyphens]{url}  % DO NOT CHANGE THIS
\usepakage{graphix} % DO NOT CHANGE THIS
\urlstyle{rm} % DO NOT CHANGE THIS
\def\UrlFont{\rm}  % DO NOT CHANGE THIS
\usepakage{natbib}  % DO NOT CHANGE THIS AND DO NOT ADD ANY OPTIONS TO IT
\usepakage{caption} % DO NOT CHANGE THIS AND DO NOT ADD ANY OPTIONS TO IT
\frenchspacing  % DO NOT CHANGE THIS
\setlength{\pdfpagewidth}{.5in}  % DO NOT CHANGE THIS
...
\usepackage{qtree}
\usepackage{nicefrac}
\usepackage{color} % to be used only foomments
...
% DISALLOWED COMMANDS
% \nocopyright -- Your paper will not be published if you use thiommand
% \addtolength -- Thiommand may not be used
% \balance -- Thiommand may not be used
% \baselinestretch -- Your paper will not be published if you use thiommand
% \clearpage -- No page breaks of any kind may be used for the final version of your paper
% \columnsep -- Thiommand may not be used
% \newpage -- No page breaks of any kind may be used for the final version of your paper
% \pagebreak -- No page breaks of any kind may be used for the final version of your paperr
% \pagestyle -- Thiommand may not be used
% \tiny -- This is not an acceptable font size.
% \vspace{- -- No negative value may be used in proximity of aption, figure, table, section, subsection, subsubsection, or reference
% \vskip{- -- No negative value may be used to alter spacing above or below aption, figure, table, section, subsection, subsubsection, or reference
...
While PP is not guaranteed to be complete (i.e., always finds a solution when one exists) or optimal (i.e., minimizes the sum of costs), it is widely adopted and can produce solutions with near-optimal sum of costs~\citep{morag2online}. Therefore improvements to PP have been proposed over the years. Windowed Hierarchical Cooperative A*~\citep{silver2005cooperative} and  Rolling-Horizon Collision Resolution~\citep{li2021lifelong} use PP iteratively in an online manner, considering in every planning period only conflicts in the next few steps.\footnote{RHCR is a general framework that has been used with PP as well as with other MAPF solvers.}
...
Program synthesis in heuristic search has been explored by~\citet{cog2020,bulitko2021fast,sergio2021,bulitko2portability} who ran various algorithms to search a space of arithmetic formulae to represent a heuristic function in single-agent pathfinding. A similar approach by~\citet{acs2020} was used to synthesize Artificial Life (A-life) agents represented as arithmetic formulae. Both are cases of program synthesis, a growing research area attempting to synthesize/learn programs (or their parts) from data.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Our Approach}
\label{ourApproach}

We adopt the approach of \citea{bulitko2portability} to synthesize priority functions for PP expressed as arithmetic formulae. We define the space of the formulae using a context-free grammar and then search this space via a genetic algorithm with regularized loss $\ell$ as the fitness function.
The resulting synthesized formula computes a priority value for each agent, taking as input a set of the agent's features (defined by \citea{zhang2learning} and explained in Table~\ref{table:features}).
This priority value is then used by PP to order the agents and solve a given MAPF instance.

\begin{table*}[t]
\centering
\small
\caption{The $ 2 $ features $ \mathbf{\Phi} = \{x_1,\dots,x_{2}\} $ for the agent $ a_i $ as defined by \citea{zhang2learning}. The \textit{cardinal conflict} and \textit{multi-value decision diagram} (MDD) come from the work of~\citea{sharon2013increasing}.}
...
\toprule
\parbox[t]{3mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\textbf{Map}}}} & \multirow{2}{*}{$\mathbf{n}$} & \multicolumn{}{c|}{\textbf{Success rate (\%)}} & \multicolumn{}{c|}{\textbf{Average solution rank}} & \multicolumn{6}{c}{\textbf{Avg. normalized sum of costs}} \\ \cline{3-20}
...
& $50$ & \hspace{4pt} $\mathbf{96}$ & $$ & $76$ & $92$ & $52$ & $\mathbf{96}$ & \hspace{4pt} $2.56$ & \hspace{4pt} $3.76$ & $\mathbf{1.4}$ & $1.60$ & $1.92$ & \hspace{4pt} $2.00$  & \hspace{4pt} $1.4$ & $1.10$ & $1.29$ & $1.46$ & $\mathbf{1.09}$ & $1.47$ \\
& $100$ & $\mathbf{96}$ & $24$ & $4$ & $40$ & $16$ & $92$ & $1.76$ & $2.$ & $1.96$ & $1.76$ & $2.64$ & $\mathbf{1.32}$ & $1.59$ & $1.16$ & $1.43$ & $1.$ & $\mathbf{1.}$ & $1.47$ \\
& $0$ & $52$ & $4$ & $20$ & $\mathbf{64}$ & $4$ & $60$ & $1.$ & $1.$ & $1.76$ & $1.28$ & $1.92$ & $\mathbf{0.72}$ & $1.60$ & $\mathbf{1.19}$ & $1.34$ & $1.67$ & $1.24$ & $1.41$ \\
& $175$ & $36$ & $0$ & $8$ & $44$ & $40$ & $\mathbf{48}$ & $1.20$ & $1.76$ & $1.48$ & $1.$ & $0.96$ & $\mathbf{0.76}$ & $1.71$ & $\infty$ & $\mathbf{1.40}$ & $1.64$ & $1.66$ & $1.45$ \\
& $200$ & $$ & $0$ & $0$ & $32$ & $28$ & $\mathbf{40}$ & $0.96$ & $1.$ & $1.$ & $0.68$ & $0.84$ & $\mathbf{0.40}$ & $1.70$ & $\infty$ & $\infty$ & $1.71$ & $1.68$ & $\mathbf{1.64}$ \\
& $225$ & $0$ & $0$ & $0$ & $4$ & $4$ & $\mathbf{8}$ & $0.16$ & $0.16$ & $0.16$ & $0.$ & $0.$ & $\mathbf{0.08}$ & $\infty$ & $\infty$ & $\infty$ & $1.82$ & $\mathbf{1.39}$ & $1.44$ \\
\midrule
...
& $5$ & $20$ & $0$ & $0$ & $24$ & $20$ & $\mathbf{28}$ & $\mathbf{0.48}$ & $0.92$ & $0.92$ & $0.60$ & $0.64$ & $\mathbf{0.48}$ & $1.88$ & $\infty$ & $\infty$ & $1.91$ & $1.88$ & $\mathbf{1.86}$ \\
& $0$ & $0$ & $0$ & $0$ & $0$ & $4$ & $\mathbf{8}$ & $0.$ & $0.$ & $0.$ & $0.$ & $0.08$ & $\mathbf{0.04}$ & $\infty$ & $\infty$ & $\infty$ & $\infty$ & $2.13$ & $\mathbf{1.81}$ \\
\midrule
...
& $200$ & $88$ & $84$ & $92$ & $\mathbf{100}$ & $\mathbf{100}$ & $\mathbf{100}$ & $2.92$ & $2.36$ & $2.60$ & $2.76$ & $2.24$ & $\mathbf{2.00}$ & $14.57$ & $21.30$ & $.79$ & $3.58$ & $\mathbf{2.91}$ & $3.70$ \\
...
& $0$ & $0$ & $0$ & $0$ & $8$ & $\mathbf{76}$ & $\mathbf{76}$ & $1.60$ & $1.60$ & $1.60$ & $1.48$ & $0.64$ & $\mathbf{0.32}$ & $60.00$ & $60.00$ & $60.00$ & $57.58$ & $27.41$ & $\mathbf{16.76}$ \\
\midrule
\parbox[t]{2mm}{\multirow{5}{*}{\rotatebox[origin=c]{90}{{\tt maze}}}}
...
& $130$ & $8$ & $0$ & $0$ & $16$ & $\mathbf{84}$ & $0$ & $1.00$ & $1.08$ & $1.08$ & $0.84$ & $\mathbf{0.08}$ & $1.08$ & $55.22$ & $60.00$ & $60.00$ & $53.89$ & $\mathbf{.81}$ & $60.00$ \\
\midrule
...
& $800$ & $96$ & $96$ & $92$ & $96$ & $\mathbf{100}$ & $92$ & $4.12$ & $2.68$ & $2.08$ & $2.24$ & $\mathbf{1.56}$ & $2.04$ & $\mathbf{60.65}$ & $148.05$ & $8.82$ & $117.32$ & $126.01$ & $124.54$ \\
...
& $900$ & $\mathbf{100}$ & $92$ & $96$ & $96$ & $92$ & $92$ & $3.68$ & $2.32$ & $2.16$ & $2.08$ & $\mathbf{2.04}$ & $2.32$ & $\mathbf{72.49}$ & $164.68$ & $3.91$ & $160.27$ & $172.58$ & $169.36$ \\
\end{tabular}
%}
\end{table*}
