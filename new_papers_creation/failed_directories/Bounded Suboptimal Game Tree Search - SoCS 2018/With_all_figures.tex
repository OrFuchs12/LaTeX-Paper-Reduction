...
%$\pess(n)=\sum_{c\in C_A(n)}\pi(c)\cdot \pess(n) + (1-\sum_{c\in C_A(n)}\pi(c))\cdot \vmin$ 
%and 
%$\opti(n)=\sum_{c\in C_A(n)}\pi(c)\cdot \opti(n) + (1-\sum_{c\in C_A(n)}\pi(c))\cdot \vmax$. 
%Since for any child $c'$ of $n$ it holds that $\pess(c')\geq\vmin$ and $\opti(c')\leq \vmax$, 
%then $\MM(n)\in [\pess(n), \opti(n)]$ as required. 
\end{proof}
...
\begin{figure*}%
    \centering
    \subfloat[$\er$ as a function on $\epsilon$]{{\includegraphics[width=5cm]{Figures/Cops_And_Robber_BAB_depth3_er.pdf} }}%
    \qquad
    \subfloat[$\amb$ as a function on $\epsilon$]{{\includegraphics[width=5cm]{Figures/Cops_And_Robber_BAB_depth3_amb.pdf} }}%
    \subfloat[$\amb$ as a function on $\er$ bins.]{{\includegraphics[width=5cm]{Figures/Cops_And_Robber_BAB_depth3_bins.pdf} }}%    
...
\begin{figure*}%
    \centering
    \subfloat[$\er$ as a function on $\epsilon$]{{\includegraphics[width=5cm]{Figures/Random_Trees_BAB_depth_chance2_er.pdf} }}%
    \qquad
    \subfloat[$\amb$ as a function on $\epsilon$]{{\includegraphics[width=5cm]{Figures/Random_Trees_BAB_depth_chance2_amb.pdf} }}%
\qquad 
    \subfloat[$\er$ as a function on $\epsilon$]{{\includegraphics[width=5cm]{Figures/Random_Trees_BAB_depth_chance2_er.pdf} }}%
    \qquad
    \subfloat[$\amb$ as a function on $\epsilon$]{{\includegraphics[width=5cm]{Figures/Random_Trees_BAB_depth_chance2_amb.pdf} }}%
...
\subfloat[$\amb$ as a function on $\er$ bins.]{{\includegraphics[width=5cm]{Figures/Random_Trees_BAB_depth_chance2_bins.pdf} }}%   
    \caption{Experimental results for the deterministic C\&R domain.}%
    \label{fig:exp-cr-det}%
\end{figure*}
