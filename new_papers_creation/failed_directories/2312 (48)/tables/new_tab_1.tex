...
\small
\centering
\captionof{table}{\small Performance comparison on CIFAR-100 dataset. We use DenseNet-101 for all baselines. Best  results are in \textbf{bold}. We report the mean and variance across 3 different training runs.}
\label{tab:cifar-100}
\resizebox{\textwidth}{!}{
\begin{tabular}{lccc}
...
\centering
\small
\captionof{table}{\small Performance comparison on near-OOD and far-OOD detection task. Architecture used is DenseNet-101 and ID data is CIFAR-10. We report the mean and variance across 3 training runs. }
\label{tab:hard_ood}
\resizebox{\textwidth}{!}{
\begin{tabular}{lcccc}
...
\cite{sun2021react} & 82.84 & 76.32 & 79.97 & 77.16\\
