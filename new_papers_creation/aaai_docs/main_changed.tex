...
The top performing model was $MK_{200}$ with an accuracy of $83\
The random baseline model performed consistently poorly with an average accuracy of $53\
The fully Bayesian model achieved an accuracy of $72\
