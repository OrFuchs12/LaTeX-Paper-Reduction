...
def show_ltitem_hierarchy(o: Any,page,page_num, depth=0):
    ...
    """Show location and text of LTItem and all its descendants. Recursive function"""
...
def run(p):
    """
    get textual contents from pdf
    :param p: path for pdf
    :return: object of textual contents from pdf
    """
