...
def perform_operators(objects, doc_index, latex_path, pdf_path,path_to_file, paper_name,lidor):  # ,path_to_file):
    ...
    print("finish perform operators")
...
def simple_greedy(path_to_pdf, path_to_latex, num_of_pages,paper_name, file_name, result_path):
    ...
    try:
        ...
        print("RESULTS: simple, ", file_name, ": ", iteration, " iterations, ", end - start, " seconds, ", reduced, " reduced, ", total_cost, " total cost")
    ...
    for paper_dir in os.scandir(directory):
        ...
        for file in os.scandir(paper_dir):
            if file.is_file():
                ...
                if file.name.lower().endswith(".tex") :
