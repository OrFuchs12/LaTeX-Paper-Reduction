...
% \newcommand{\Kshitij}[1]{\todo[color=green!40]{Kshitij says: #1}}
% ==================
...
% ======================================================
% Added the figure here, so it shows up before we describe the ESIM model and the results table can be moved up by one page
% ======================================================
\begin{figure*}[h]
\centering
...
% commented to restrict references to 1 page only
% \citeauthor{shang2015neural} \shortcite{shang2015neural};
...
% \citeauthor{dodge2015evaluating} \shortcite{dodge2015evaluating})
...
% commented to restrict the main paper to 6 pages
% \citeauthor{baudivs2016sentence} \shortcite{baudivs2016sentence} employed a deep neural network structure where LSTM based network was used to model long-term dependencies and CNN based model and pooling was used to capture gist of the sentence.
...
% \begin{figure*}[h]
% \centering
% \includegraphics[width=0.98\textwidth]{AuthorKit19/LaTeX/images/esim_manpages_v3.png}
% \caption{\textbf{K-ESIM}: A high-level overview of K-ESIM model, which incorporates external knowledge from man pages.}
% \label{fig_k_esim}
% \end{figure*}
...
% to save space
% , as shown in equations \ref{eqContextRepresentationLayer1} and \ref{eqContextRepresentationLayer2}.
below.
...
\begin{tabular}{lcccc|cccc}
    ...
    % TODO - ===================================
    % Uncomment these 3 lines when we have the validation results
    % T-ESIM-CR & - & - & - & - & 52.8 & 83.7 & 97.4 & 0.6416\\ \hline
    % T-ESIM-Sampled & 47.48 & 78.44 & 96.44 & 0.5860 & 53.2 & 82.1 & 95.6 & 0.6359\\ \hline
    % T-ESIM-Sampled-CR & - & - & - & - & 53.9 & 84.3 & 97.2 & 0.6469\\ \hline
    % ===================================
...
% We created external knowledge via further processing these man pages. Information retrieval (IR) or text-based similarity techniques are quick and easy way to find relevant information.
% In our approach, we focused on text-based similarity technique specifically TF-IDF vectors to represent descriptions from 1200 man pages.
...
% Since the values in the relation hashtable are command names, we get a list of command names.
These matches eventually lead us to the list of command names relevant to the given dialog.
% The command names are sorted by their length as larger command names have a higher chance of being useful for the given context. Once we have a list of all the command name matches, we re-rank their corresponding descriptions by their TF-IDF scores against the context and use the top match as the external information for that particular context.
...
% In addition to that, each conversation contains information about the student profile. This includes information such as prior courses, suggested courses, term, etc.
% Our hypothesis is that suggested courses given in the profile would be helpful to the advisor when suggesting courses to the student. For each course given in the suggested courses in the profile, we refer to the course information provided in the external information KB.
...
% From the information given for that course in the KB, we construct a string from predefined rules, which contains information about the course.
...
% The information strings created for all the suggested courses were used as the external information for each conversation.
% An example information for a conversation is \texttt{EECS376 is Foundations of Computer Science, has easy workload,  small class size,  4 credits,  has a discussion, the classes are on Monday,  Wednesday morning, afternoon. EECS281 is Data Structures and Algorithms, has moderate workload,  large class size,  4 credits,  has a discussion, the classes are on  Thursday, Tuesday afternoon. EECS370 is Introduction to Computer Organization, has easy workload,  large class size,  4 credits,  has a discussion, the classes are on  Thursday, Tuesday afternoon.}
...
% We hypothesized that traditional training approach would lack emphasis on the common patterns in these dialogs.
...
%     \multirow{2}{*}{\textbf{Model}} & \multicolumn{4}{c}{\textbf{Validation}} & \multicolumn{4}{c}{\textbf{Test}}\\
%      & R@1 & R@10 & R@50 & MRR & R@1 & R@10 & R@50 & MRR  \\ \hline
%     \multicolumn{9}{c}{subtask-1}\\\hline
%     % Dual Encoder & 8.32  & 35.98  & 80.04  & - & - & - & - & - \\ \hline
%     ESIM & 43.76 & 71.70 & 95.84 & 0.5324 &  50.1 & 78.3 & 95.4 & 0.5934 \\ \hline
%     T-ESIM & 52.62 & 76.46 & 96.08 & 0.6057 & 61.9 & 82.2 & 96.6 & 0.6909\\ \hline
%     \multicolumn{9}{c}{subtask-2}\\\hline
%     % &   &   &   &  &  &  &  &  \\ \hline
%     ESIM & 11.12 & 31.5 & 58.6 & 0.1859 &  12.8 & 28.5 & 36.5 & 0.1843 \\ \hline
%     T-ESIM & 18.72 & 35.9 & 61.26 & 0.2513 & 21.6 & 36.0 & 44.1 & 0.2668 \\ \hline
%     \multicolumn{9}{c}{subtask-4}\\\hline
%     % &   &   &   &  &  &  &  &  \\ \hline
%     ESIM & 40.16 & 76.18 & 96.36 & 0.5343 &  43.5 & 82.1 & 96.2 & 0.5796 \\ \hline
%     T-ESIM & 47.76 & 77.22 & 96.40 & 0.5843 & 52.5 & 82.3 & 97.1 & 0.6360 \\ \hline
%     \multicolumn{9}{c}{subtask-5}\\\hline
%     %  &   &   &   &  &  &  &  &  \\ \hline
%     K-ESIM & 44.82 & 72.74 & 96.4 & 0.5452 &  50.1 & 78.3 & 96.3 & 0.6020 \\ \hline
%     TK-ESIM & 53.10 & 75.88 & 96.26 & 0.6088 & 60.9 & 80.2 & 96.6 & 0.6793 \\ \hline
% \end{tabular}
% \end{center}
% \caption{\textbf{Validation and Test results for Ubuntu V3.}}
% \label{tab:baseline-results-ubuntu}
% \end{table*}
% ====================================================
...
%     ESIM & 43.76 & 71.70 & 95.84 & 0.5324 &  50.1 & 78.3 & 95.4 & 0.5934 \\ \hline
%     T-ESIM & 52.62 & 76.46 & 96.08 & 0.6057 & 61.9 & 82.2 & 96.6 & 0.6909\\ \hline
%     T-ESIM-CR & 54.46 & 79.26 & 97.92 & 0.6273 & 63.4 & 84.2 & 98.5 & 0.7069\\ \hline
%     T-ESIM-Sampled & 53.16 & 78.5 & 96.46 & 0.6154 & 62.8 & 83.4 & 96.6 & 0.6970\\ \hline
%     T-ESIM-Sampled-CR & 55.46 & 81.98 & 98.2 & 0.6412 & 64.3 & 84.7 & 97.3 & 0.7125\\ \hline
%     \multicolumn{9}{c}{\textbf{subtask-2}}\\\hline
%     % &   &   &   &  &  &  &  &  \\ \hline
%     ESIM & 11.12 & 31.5 & 58.6 & 0.1859 &  12.8 & 28.5 & 36.5 & 0.1843 \\ \hline
%     T-ESIM & 18.72 & 35.9 & 61.26 & 0.2513 & 21.6 & 36.0 & 44.1 & 0.2668 \\ \hline
...
%     K-ESIM & 44.82 & 72.74 & 96.4 & 0.5452 &  50.1 & 78.3 & 96.3 & 0.6020 \\ \hline
%     TK-ESIM & 53.10 & 75.88 & 96.26 & 0.6088 & 60.9 & 80.2 & 96.6 & 0.6793 \\ \hline
%     TK-ESIM-CR & 54.84 & 79.26 & 97.96 & 0.6298 & 62.3 & 83.4 & 97.8 & 0.6956\\ \hline
