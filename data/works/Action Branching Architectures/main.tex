...
% Convert natbib style citation commands to aaai style:
\newcommand{\citet}[1]
...
\begin{figure*}[ht] 
  ...
  \includegraphics[height=32.75mm]{img/Hopper-v1-results.pdf}\\ \vspace{.2mm}
