...
%Indeed, \citet{zeng2021musicbert} has pointed out the crucial difference between symbolic music and natural language, including music's multi-dimensional structure (e.g., bar, position, instrument, velocity, etc.) and great length. Unfortunately, there lacks evidence that text-to-music transfer is viable for LLMs.
...
%Regarding subjective evaluation, we consider as reference a small body of work in music psychology on listeners' preference of drum grooves \cite{senn2018groove}. We propose a suite of metrics with drum composition in mind, which could potentially be applied to other music generation tasks.
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6]{images/duplication.png}
