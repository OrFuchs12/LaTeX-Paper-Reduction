...
% The goal is satisfied if the goal ground atoms are a subset of the state ground atoms.
...
%We see in experiments that this phrase together with the ``simple'' qualifier is enough to guide the LLM toward efficient solutions.
...
% We address each of these questions quantitatively and report qualitative observations.
...
We conclude with limitations of this work, reflections about the implications of our findings, and opportunities for future work.
...
Examples of programs synthesized by GPT-4 with CoT summarization and automated debugging are shown in Listings~\ref{delivery_example1}, \ref{forest_example1}, \ref{gripper_example1}, \ref{miconic_example1}, \ref{ferry_example1}, \ref{spanner_example1}, and \ref{heavy_example1}.
Any comments in the code are added by GPT-4 itself.

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/delivery_example1.py}
\caption{\textbf{Delivery} domain example synthesized program (success)}
\label{delivery_example1}
\end{listing*}

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/forest_example1.py}
\caption{\textbf{Forest} domain example synthesized program (success)}
\label{forest_example1}
\end{listing*}

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/gripper_example1.py}
\caption{\textbf{Gripper} domain example synthesized program (success)}
\label{gripper_example1}
\end{listing*}

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/miconic_example1.py}
\caption{\textbf{Miconic} domain example synthesized program (failure)}
\label{miconic_example1}
\end{listing*}

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/ferry_example1.py}
\caption{\textbf{Ferry} domain example synthesized program (success)}
\label{ferry_example1}
\end{listing*}

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/spanner_example1.py}
\caption{\textbf{Spanner} domain example synthesized program (failure)}
\label{spanner_example1}
\end{listing*}

\begin{listing*}[!ht]
\small
\inputminted{python}{example_programs/heavy_example1.py}
\caption{\textbf{Heavy} domain example synthesized program (success)}
\label{heavy_example1}
\end{listing*}
