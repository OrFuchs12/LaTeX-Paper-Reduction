...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Notes:
%   Longer lifetime tasks -> need for in-situ/in-mission self-assessments
%           Future work: fast in-mission assessments
%   Longer lifetime of teaming -> need to a posteriori (after-action) self-assessments
%           Future work: incorporating feedback/experience into the agents models
%
...
\begin{figure}[htbp]
    \centering
    %\includegraphics[width=0.4\textwidth]{images/cont_prop_vs_displayed_reports_single_color.png}
...
\begin{figure}[htbp]
    \centering
    %\includegraphics[width=0.4\textwidth]{images/cont_prop_vs_displayed_reports_single_accurate_only_color.png}
