...
%DACM (ECCV'22)~\citeyear{zhu2020deformable}       &							&66.5&72.6&62.2&\underline{61.3}&65.7	&\underline{72.4}&73.7&69.1&\textbf{68.4}&\textbf{70.9}	\\
%IPMT (NeurIPS'22)~\citeyear{liu2022intermediate}	& 							&\textbf{72.8}&\textbf{73.7}&59.2&\textbf{61.6}&\underline{66.8}	&\textbf{73.1}&\underline{74.7}&61.6&63.4&68.2	\\
...
%DACM (ECCV'22)~\citeyear{zhu2020deformable}     	&							&68.7&73.5&63.4&\textbf{64.2}&\textbf{67.5}	&\underline{72.7}&75.3&68.3&\textbf{69.2}&\underline{71.4}	\\
%IPMT (NeurIPS'22)~\citeyear{liu2022intermediate}	& 							&\textbf{71.6}&\underline{73.5}&58.0&61.2&66.1	&\textbf{75.3}&\textbf{76.9}&59.6&65.1&69.2	\\
...
%DACM~\citeyear{zhu2020deformable}       & 							&37.5&44.3&40.6&\underline{40.1}&40.6	&\textbf{44.6}&\underline{52.0}&\underline{49.2}&46.4&\underline{48.1}	\\
%IPMT (NeurIPS'22)~\citeyear{liu2022intermediate}	&                         &\textbf{41.4}&\underline{45.1}&\textbf{45.6}&40.0&\underline{43.0}&43.5&49.7&48.7&\underline{47.9}&47.5	\\
...
%is a simply modified version of CyCTR which excludes the training samples containing objects of the novel class.
...
%w/o activation&63.0&70.6&64.3&55.5&63.4\\
...
%un(w/ guide)+contra loss&not start yet&&&&\\
...
%In the Appendix, we further investigate the effects of data re-sampling and different designs for unlabeled branches, and those results are all consistent with the theoretical analysis in Sec.3.
