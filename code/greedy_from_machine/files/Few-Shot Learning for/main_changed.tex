...
% Detection of Rare Road Objects in Unstructured Driving Conditions}
...
%\author{
% \Large \textbf{
% MetaLearn 2020 - AAAI Workshop Paper \#4
% } \\
%%AAAI workshop submission
%}
 \begin{document}
\maketitle
...
\begin{enumerate}
    ...
    %\item Definition of new object categories in an existing driving dataset
    %\item Investigate few-shot object detection techniques for best performance on driving images
    %\item We show that current few-shot object detection algorithms fail to address the inter-class confusion
...
% Can be Added but this is causing page limit to exceed
...
% This is referenced in the Methods section - put here for formatting
\section{Approach}
\label{approach}
\begin{figure*}[t]
      \centering
...
%We adopt a two-stage training strategy to achieve this learning objective:
...
% This figure will be referenced by TFA method
\begin{figure*}[t]
      \centering
...
%we evaluate the performance of several few-shot object detection architectures described in the $Approach$ section of the paper on
...
% Reference section - adapted from references.bib
\bibliographystyle{aaai}
At accusantium eaque, saepe esse voluptas vitae pariatur necessitatibus facere dolorem ad?Nesciunt temporibus veritatis aliquam deleniti, neque voluptate culpa quidem doloremque quia tempore, laudantium facilis praesentium sapiente?\clearpage
