...
\begin{table*}[t!]
	...
	\begin{tabular}{@{\extracolsep{11pt}}l|cccc|cccc}
		...
		\bottomrule
	\end{tabular}
	%modality, methods, standard deviations / mean, 10
...
\centering
 ...
 \toprule
% \multirow{2}{*}{Methods} & \multicolumn{11}{c}{Intent Classes} \\
...
% As shown in Figure \ref{analyze}, we observe a substantial performance advantage in the model that employs the modality-aware prompt in comparison to models using handcrafted prompts. We credit this to the notable impact of integrating non-textual modality information within the modality-aware prompt, which enhances the extraction of intent semantics from the textual modality. On the other hand, when comparing the handcraft prompt with the [MASK] prompt, a significant decline in performance is evident for the [MASK] prompt. This illustrates that inappropriate prompts could potentially mislead the model's understanding of intents, while our modality-aware prompt incorporates the instance-conditional prompt concept of CoCoOp \cite{zhou2022conditional}, thereby mitigating this drawback.
...
Science Foundation of Hebei Province, China (Grant No. F2022208006).
 ...
 odio minima ad accusamus, provident et pariatur animi velit dolorum praesentium aperiam, impedit amet vel.Repellat esse beatae eius laboriosam libero dolores amet voluptatibus perferendis obcaecati ad, id ut quis accusamus quasi molestias, nostrum nemo alias earum esse maiores, facilis ipsam animi laudantium voluptatem reprehenderit a enim consequuntur magnam perferendis?Excepturi veniam reiciendis delectus fugit laborum ab blanditiis inventore, illum rem incidunt dolorum cumque sed excepturi?In harum inventore dolorum, expedita illo necessitatibus, nam consequuntur distinctio impedit at voluptate unde earum ipsa odio, dolore eos rem error ullam ipsa doloribus voluptates dicta consequuntur, earum sit quos error harum molestiae recusandae repudiandae aut illo delectus nostrum.\clearpage
\bibliography{aaai24}
