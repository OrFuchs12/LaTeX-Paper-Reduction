...
%showing how much work is applied to have the projects done.
%The large effort of game development is widely acknowledge in both industry and academia.
%The use of AI-assistance was pointed to be a solution in order
...
of workload.
\end{abstract}
%\dan{what does it mean to increase affect?}
...
%Unfortunately this exciting environment is also a stage for delayed projects, often going over budget and requiring crunch times and harming the quality of life of the industry professionals~\cite{Potanin:2010:FPB:1823818.1823833}.
% about crunch times in vg industry
%igda - https://cdn.ymaws.com/www.igda.org/resource/collection/9215B88F-2AA3-4471-B44D-B5D58FF25DC7/Collective%20Creativity%20Workshop.F.03.pdf
...
%Although the causes which lead game projects to this catastrophic scenario are many\cite{Potanin:2010:FPB:1823818.1823833}, it is agreed upon by researchers and professionals that the tools used to implement the games are partly to blame \cite{petrillo2009went,washburn2016went}.
...
%\dan{what is "variety level"?}

%Self-efficacy, affect, and workload were chosen because they are an indicator of the user productivity when using a tool to perform a task. By having appropriate tools the users can think more about their design and spend less time dealing with tool issues. We hope the results presented here will foster a new generation of AI-assistants for game design tasks focused both on its technical aspects as the human ones.
...
%-cicero debugging assistant

%-flex to generate prototypes for different genres
%-recommender system
%-decreases workload, increases self-efficacy, effect
...
%The tools presented in the previous session have a great impact on the game research community and game industry. Actually, some games produced during the rise of AI-driven game design assistants could not have been created without Procedural Content Generation methods, such as Galactic Arms Race \cite{Hastings:2010:GAR:1810136.1810137} and Borderlands for example.
...
% \begin{figure}[!hb]
% \centering    \includegraphics[width=.99 \columnwidth]{/Figs/games_catalog.png}
%     \caption{From left to right we have elements from the games: Pacman, Zelda, and Frogger. These elements carries an specific behavior (type), they can shoot, move randomly, back and forth, etc.
%     They are coded based on their unique behaviors. The Apriori algorithm will then define a list of association rules of elements behaviour between and within games.}
...
Eius consequatur itaque eveniet harum corrupti corporis veniam doloribus laboriosam beatae, id ab magni dolore consequuntur reprehenderit, reprehenderit sint quas itaque quia?Exercitationem odio aut porro, provident rem repudiandae, possimus ex officia nemo atque rem corporis libero ipsum voluptas saepe iure, eligendi nobis
\bibliography{sample}
\end{document}