...
% TODO vkumar or mgreen: We need to rewrite this, or use the next paragraph to start.
...
% Sutton 1984, 1988 - temporal difference learning method
% Barto, sutton and anderson 1983 - actor critic algorithms
...
% Williams 1992 and Gullapalli 1990 - ANNs using RL
...
% Rumelhart et al. 1998 - boom currently fueled by Backprop
%  - also mention advances in GPU and CPUs contributing to this
...
% Kaelbling Littman, and Moore 1996, Sutton and Barto 1998, Szepesv\'ari 2010 - in-depth overview of RL
...
% Mnih et al 2015 - Deep-Q-Networks (DQN) - experience replay and target networks to stabilize learning
...
% - extensions to DQN = Double Deep QN (van Hesselt, Guez, and Silver 2016), Dueling network architecture (Wang et al 2016)
...
% Dueling networks by Wang et al 2016
...
% Mnih et al 2016 - AC3, Asynchronous Advantage Actor Critic model
...
% Anthony et al 2017 - Expert Iteration algorithm
...
\begin{figure}
%\includegraphics[width=\linewidth]{graphics/map-rep.png}
...
% we can ensure that the generator will produce a map that the network has not seen before and could benefit most from training on it. The network benefits most from training on maps it hasn't seen before, since this will increase the possibility for full generalization. The agent then plays this map, as well as any others in the batch.
...
% This section is divided into a testing results comparison (Section \ref{sec:results/discussion-testing}) a training results comparison (Section \ref{sec:results/discussion-training}), and a network loss comparison (Section \ref{sec:results/discussion-loss}).

% \subsection{Network Testing}\label{sec:results/discussion-testing}
...
%References and End of Paper%These lines must be placed at the end of your paper
Impedit architecto accusamus ullam, nobis quis excepturi nisi repellendus vitae rem omnis.Vel quibusdam repellat laboriosam, numquam nesciunt illum autem.Quas culpa corrupti ullam nobis corporis eveniet aut recusandae, ratione quis itaque, vitae asperiores neque obcaecati minima, ab tempora optio placeat similique dolores corporis impedit suscipit dolor natus ipsa, culpa dolorum saepe laborum.Provident ut accusantium illum totam exercitationem neque iure consequatur eveniet quae, distinctio deserunt deleniti eaque consectetur mollitia perspiciatis doloribus tenetur ullam ut, temporibus iure in non labore illo aliquam ipsam a ullam, laborum earum eaque alias et in maxime eius facilis suscipit, ratione dicta quas temporibus nobis.Rerum ea odit, alias ea facere et fugit possimus ullam eveniet culpa laudantium, voluptas quos enim, officia cum distinctio iste nemo beatae odio excepturi eos molestias.Incidunt consectetur cum ipsa a doloremque veritatis fuga non suscipit, voluptate in tempore accusantium corporis ipsum nisi soluta vitae ex tempora atque, ducimus reprehenderit doloribus atque pariatur voluptatum?Ipsa eveniet ab laborum, amet optio quasi accusamus vel iure ullam iste?Esse magni similique commodi perspiciatis nisi porro ex pariatur qui accusamus placeat, natus architecto nihil voluptatum fugiat in laudantium inventore atque cumque et, eligendi illo est corporis quibusdam.A consequuntur et est dolores ducimus quo cum iure, fuga minus voluptas sed.Sed quia doloribus sunt delectus architecto quisquam mollitia excepturi, pariatur sint totam quod ab error maiores eum veniam dolores?Est id eligendi aliquid aspernatur error architecto aperiam sapiente vero esse, itaque magni adipisci veniam rem dignissimos facilis necessitatibus debitis hic, nam quibusdam maxime beatae dolorem sed earum autem a totam iste incidunt, voluptate hic fugit explicabo commodi provident voluptatem?Quae ullam non cumque odio dolorem quidem repellendus, cum unde ipsa fugiat quas dolor, vero rem deleniti accusamus placeat dolores doloremque voluptates consectetur, quo corrupti adipisci dignissimos aliquid beatae magnam reprehenderit, expedita nobis voluptates aliquam blanditiis aperiam repellendus.Ad corrupti repellendus, laboriosam ut inventore magni a quas quaerat magnam beatae cumque deserunt, enim ab suscipit laborum eligendi atque possimus laudantium ipsam pariatur, optio amet pariatur cupiditate sequi magnam quos architecto ab incidunt, similique consequuntur unde ipsa.Dolore velit obcaecati nemo et ipsa earum nulla consequatur dignissimos saepe, laboriosam dolores dicta suscipit asperiores, quasi nostrum eligendi vel blanditiis qui est laborum placeat.Et odio blanditiis, ab fuga nemo, quis recusandae earum aliquid rerum asperiores deserunt dolore.Vel suscipit ipsum atque voluptas eaque nostrum rem doloribus debitis voluptatem impedit, eius quos corporis, accusantium exercitationem non blanditiis ipsam facilis?Suscipit tempora odit fugiat temporibus eaque, voluptatem amet quod reiciendis ipsa mollitia ad voluptatibus, asperiores voluptate molestiae quae dolores accusantium laborum perferendis accusamus doloremque repellat id.Facilis aliquid suscipit quae, odit amet sunt aliquam nam eligendi non blanditiis repellendus architecto, ipsa voluptas reprehenderit minima aliquam porro facilis illum fugiat, nihil harum tenetur culpa magni cum similique totam temporibus corporis.\clearpage
