...
% \usepackage{enumerate} % ADD ILIAS
...
% In this work, we bring to the spotlight the farmer and her/his needs.
...
% We present causal inference on observational data as a viable framework in order to asses the effectiveness of all these tools.
...
% A paragraph 3 to 5 lines introduce nicely the reader to the main concept.

% After that a restructure of next text based on a pre-designed flow.
...
% and in most cases adoption rate percentages range among single-digits and low double-digits
...
% Therefore, more often than not, the claimed benefits of such tools are undounded promises.
...
% to clarify assumptions towards the better physical-processes understanding
...
% Still, decision-making at the farm should be based on more reliable methods than simpleminded descriptive studies.
...
% This can be done by simply comparing what the digital tool will cost to what is expected to be gained in terms of yield; a straightforward calculation not requiring advanced financial expertise.
