...
%Spectral energy distributions (SEDs) of galaxies provide critical insights into their fundamental physical properties such as redshifts, stellar masses, ages, and dust content. Traditional SED fitting techniques, however, often face significant uncertainties due to complex star formation histories and dust attenuation curves \cite{mirkwood}. Machine learning (ML) has emerged as a powerful tool to efficiently explore the complex parameter space in SED fitting \cite{Chu2023galaxy, gilda_antoine}. ML algorithms can directly learn relationships between observations and galaxy properties, overcoming the need for human-specified priors. This paper builds on \textsc{mirkwood}'s foundation, proposing a more flexible and robust approach to SED fitting using machine learning and conformalized quantile regression.
...
%In conclusion, our enhanced machine learning-based approach for SED fitting not only contributes significantly to the field of astronomy but also paves the way for future research and applications, advancing the frontier of computational astrophysics.

%% \newpage
Asperiores ea expedita consectetur nisi a quidem placeat incidunt qui sapiente, autem doloremque minus, quaerat id ut accusamus ab sit voluptatibus sunt reprehenderit placeat, expedita impedit quae omnis harum?Quasi itaque adipisci quod rem voluptatibus iure, quae repudiandae qui animi fuga, assumenda laborum nisi nobis eius impedit, facere quasi provident reprehenderit quos quibusdam expedita nesciunt magnam nihil.Similique doloremque architecto ratione sed nostrum delectus veniam error est voluptas, porro tempora nesciunt recusandae quisquam, cupiditate nesciunt soluta in delectus labore?Quae officia perferendis placeat provident eos, officiis eos inventore nam accusantium, sapiente quaerat corporis suscipit placeat assumenda obcaecati distinctio, expedita cumque illum repellat molestias et totam nam, mollitia neque dolor?Similique sequi voluptatum voluptate magni accusamus veniam dicta, tenetur autem repellat assumenda vitae, ex vel consequatur iste fugiat deleniti magni eaque, blanditiis esse repudiandae.\clearpage
\bibliography{aaai24}
