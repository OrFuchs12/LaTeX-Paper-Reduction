    ...
    for file_index in range(1):
        ...
        for object in res:
            ...
            if (object['Type'] == 'Figure'):
                ...
                if (dct[object_name]['height'] < min_figure_y_space[1]):
                ...
                if (dct[object_name]['height'] < min_table_y_space[1]):
            ...
            elif (object['Type'] == 'Par' or object['Type'] == 'Title' or object['Type'] == 'AbstractSection' or
                  object[
                      'Type'] == 'AbstractPar' or object['Type'] == 'Section' or object['Type'] == 'SubSection' or
                  object[
                      'Type'] == 'SubSubSection' or object['Type'] == 'Enum' or object['Type'] == 'Algorithm'):
                if (object['Type'] == 'Par'):
                    par_index += 1
                    index = par_index
                ...
                if (object['Type'] != 'Algorithm' and object['Type'] != 'Section' and object[
                    'Type'] != 'SubSection' and
                    ...
                    if (object[
                        'Type'] == 'Par'):  # we could change it that many of the same size will count as max, not only a single first max (or min)
                        ...
                        if (dct[object_name]["number_of_lines"] < min_lines_par[1]):
                        ...
                        if (dct[object_name]["number_of_lines"] < min_lines_enum[1]):
            ...
            if (dct[object_name]['height'] < min_height_object[1]):
