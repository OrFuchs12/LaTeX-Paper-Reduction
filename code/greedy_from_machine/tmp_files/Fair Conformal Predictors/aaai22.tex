...
/Author (Charles Lu, Andreanne Lemay, Ken Chang, Kathi Hoebel, Jayashree Kalpathy-Cramer)
...
% \section{Subgroup Uncertainty Correlation}
%   \begin{table*}[ht]
%     \small
%     \centering
%     \begin{sc}
...
%     \toprule
%     & \bf{Method} & \bf{1} & \bf{2} & \bf{3} & \bf{4} & \bf{5} & \bf{6} & \bf{Aggregate}\\
%     \midrule
%     \multirow{5}{*}{\rotatebox[origin=c]{90}{\bf{Softmax}}}
%     & Naive & 0.697 & 0.622 & 0.670 & 0.657 & 0.672 & 0.668 & 0.660 \\
%     & APS   & 0.621 & 0.612 & 0.655 & 0.636 & 0.649 & 0.676 & 0.646 \\
%     & RAPS  & 0.623 & 0.612 & 0.656 & 0.636 & 0.650 & 0.673 & 0.647 \\
%     & GAPS  & 0.610 & 0.613 & 0.656 & 0.638 & 0.654 & 0.667 & 0.607 \\
%     & GRAPS & 0.613 & 0.613 & 0.658 & 0.641 & 0.658 & 0.669 & 0.611 \\
%     \midrule
%     \multirow{5}{*}{\rotatebox[origin=c]{90}{\bf{Entropy}}}
%     & Naive & 0.908 & 0.900 & 0.817 & 0.897 & 0.914 & 0.902 & 0.909 \\
%     & APS   & 0.894 & 0.883 & 0.899 & 0.874 & 0.893 & 0.895 & 0.893 \\
%     & RAPS  & 0.895 & 0.884 & 0.901 & 0.876 & 0.894 & 0.896 & 0.894 \\
%     & GAPS  & 0.876 & 0.886 & 0.901 & 0.878 & 0.898 & 0.882 & 0.835 \\
%     & GRAPS & 0.879 & 0.887 & 0.904 & 0.880 & 0.901 & 0.884 & 0.839 \\
%     \bottomrule
%     \end{tabular}
%     \end{sc}
%     \caption{Spearman correlation between conformal uncertainty and epistemic uncertainty (maximum softmax probability and predictive entropy) for each Fitzpatrick skin type group at $\alpha=0.1$.}
%     \label{tab:subgroup-correlation}
%     \end{table*}
