...
\begin{figure*}[tb]
\centering
\subfloat[Hint Learning Epochs]{\includegraphics[width=2.15in]{figures/hint.jpg}}\quad
\subfloat[Iterations]{\includegraphics[width=2.15in]{figures/r-kd.jpg}}\quad
\subfloat[Batch Size]{\includegraphics[width=2.15in]{figures/batch.jpg}}\\
\subfloat[Noise Scale]{\includegraphics[width=2.15in]{figures/sigma.jpg}}\quad
\subfloat[\# of Query Samples]{\includegraphics[width=2.15in]{figures/sel.jpg}}\quad
\subfloat[Testing Accuracy]{\includegraphics[width=2.15in]{figures/bound.jpg}}
...
\begin{figure*}[tb]
\centering
\subfloat[MNIST]{\includegraphics[width=2.15in]{figures/mnist.jpg}}\quad
\subfloat[SVHN]{\includegraphics[width=2.15in]{figures/svhn.jpg}}\quad
\subfloat[CIFAR]{\includegraphics[width=2.19in]{figures/cifar.jpg}}
