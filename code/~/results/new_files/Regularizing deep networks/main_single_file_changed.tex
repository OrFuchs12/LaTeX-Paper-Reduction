...
\begin{figure*}[!th]
  \centering
  \subfloat[$\epsilon=0, 91.9\% $]{\includegraphics[scale=0.23]{eps_0_0.png}\label{fig:f1}}
  \hfill
  \subfloat[$\epsilon=0.02, 69.4\%$]{\includegraphics[scale=0.23]{eps_0_02.png}\label{fig:f2}}
  \hfill
  \subfloat[$\epsilon=0.04, 48.2\%$]{\includegraphics[scale=0.23]{eps_0_04.png}\label{fig:f3}}
  \hfill
  \subfloat[$\epsilon=0.06, 34.6\%$]{\includegraphics[scale=0.23]{eps_0_06.png}\label{fig:f4}} \\

  \subfloat[$\epsilon=0, 91.9\%$]{\includegraphics[scale=0.23]{eps_0_0.png}\label{fig:f1}}
  \hfill
  \subfloat[$\epsilon=0.02, 91.85\%$]{\includegraphics[scale=0.23]{eps_0_02_random.png}\label{fig:f2}}
  \hfill
  \subfloat[$\epsilon=0.04, 91.9\%$]{\includegraphics[scale=0.23]{eps_0_04_random.png}\label{fig:f3}}
  \hfill
  \subfloat[$\epsilon=0.06, 85.8\%$]{\includegraphics[scale=0.23]{eps_0_06_random.png}\label{fig:f4}}
...
\begin{figure*}[!th]
  \centering
  \subfloat[CIFAR-10]{\includegraphics[scale=0.2]{cifar10-vgg-nodrop-flip.png}}
   \subfloat[CIFAR-100]{\includegraphics[scale=0.2]{cifar100-vgg-nodrop-flip.png}}
...
Iste error quidem asperiores doloremque facilis facere quia deserunt eos corrupti vel, nobis ad error illo?Quaerat vitae ab minus molestiae vel laboriosam quam eos, nulla velit quia optio voluptatibus eveniet iusto cupiditate magnam veritatis, beatae nostrum quam minus dolores, id sit sunt enim, laudantium voluptates accusamus minima numquam
