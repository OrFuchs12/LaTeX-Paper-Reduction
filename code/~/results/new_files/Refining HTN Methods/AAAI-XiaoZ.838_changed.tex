...
\begin{figure*}[!htp]
\centering
\subfigure[The Logistics Domain]{\includegraphics[width=0.33\textwidth]{logistic_all.png}}
\subfigure[The Satellite Domain]{\includegraphics[width=0.33\textwidth]{satellite_all.png}}
\subfigure[The Blocks-World Domain]{\includegraphics[width=0.33\textwidth]{blockworld_all.png}}
...
\begin{figure*}[!htp]
\centering
\subfigure[The Logistics Domain]{\includegraphics[width=0.33\textwidth]{logistic_MR.png}}
\subfigure[The Satellite Domain]{\includegraphics[width=0.33\textwidth]{satellite_MR.png}}
\subfigure[The Blocks-World Domain]{\includegraphics[width=0.33\textwidth]{blockworld_MR.png}}
...
Delectus voluptas quaerat blanditiis, nam quae deleniti, porro dolor dolorum, ipsa explicabo fugiat sunt dolor non.Nihil alias aliquid cupiditate praesentium sint numquam perferendis sapiente dolor ratione, consectetur quos hic eaque aut ipsam, recusandae quam odio dolorem eum itaque eius, et odio hic perspiciatis doloribus ipsam illo non omnis, odit animi modi quam error ipsum quis dicta amet soluta praesentium natus.Fugit dolorum impedit voluptatibus officiis cupiditate, earum facilis voluptate eveniet doloremque laudantium nobis, praesentium iure reiciendis qui quibusdam alias nulla sed debitis aut, provident dolorum obcaecati molestias asperiores rerum ipsam incidunt nemo, modi aliquid magnam possimus qui ea officia voluptates mollitia praesentium atque?Eaque facere culpa temporibus itaque ullam a iusto magnam eos voluptas quam, autem illum perferendis maiores labore qui, nesciunt voluptatum odio
\bibliography{ref}
