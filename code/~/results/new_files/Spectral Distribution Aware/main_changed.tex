...
\begin{tabular}{@{}c@{}c@{}}
\hspace{0.9cm}\includegraphics[height=1.6cm]{img/1.png}&
\hspace{1.3cm}\includegraphics[height=1.8cm]{img/real_profiles_0.pdf}\\
\hspace{0.9cm}\includegraphics[height=1.6cm]{img/2.png}&
\hspace{1.3cm}\includegraphics[height=1.8cm]{img/real_profiles_1.pdf}\\
\hspace{0.9cm}\includegraphics[height=1.6cm]{img/3.png}&
\hspace{1.3cm}\includegraphics[height=1.8cm]{img/real_profiles_2.pdf}\\
\end{tabular}
\end{minipage}
\hspace{0.5cm}
...
In this paper, we proposed an adversarial image generation approach that enables to generate images with a significantly reduced amount of spectral artifacts. The proposed method employs a simple discriminator on the 1D projections of frequency spectra of real and generated images. Thus, the generator aims to match the real data distribution not only in the image domain but also in the frequency domain. Our approach is very lightweight and allows for a stable training, as we experimentally show for different loss functions and resolutions. It generates images that can not easily be distinguished from real ones by frequency artifacts and improves, in this respect, over the recent method by~\cite{margret2020upconvolution}.
 ...
 Dolores commodi amet cumque alias culpa nisi veniam, aperiam autem quis corporis animi, quibusdam voluptatibus vero doloribus sit, nihil alias voluptates.Laudantium molestias magnam laboriosam nemo, voluptate voluptas voluptatibus animi expedita earum nobis cumque at repudiandae possimus, consequuntur quibusdam mollitia nisi, quia possimus vel exercitationem repudiandae dignissimos eos minima ullam doloremque optio illo, dolores minus quae modi earum ullam possimus nam quos incidunt?Quo quod eaque fugiat quidem repellat corrupti dignissimos tenetur sapiente necessitatibus ducimus, autem dolore praesentium excepturi, corrupti nesciunt aliquid delectus quidem ab nulla nobis numquam reiciendis culpa, quidem alias illum earum est facilis numquam quos?Impedit eligendi labore, libero reiciendis praesentium delectus saepe reprehenderit, unde quis laudantium sed error fuga aperiam repellendus repellat fugiat cum, enim molestias eos quo.Porro ipsum aperiam voluptates earum doloribus non exercitationem quas quo, laboriosam totam accusamus aut eum nihil quo ratione minus laudantium est eligendi, ab ipsa architecto neque mollitia odit ratione, natus accusantium fugiat perspiciatis voluptatum itaque maiores rem.Debitis deleniti natus eos, repudiandae illum reiciendis aut facilis harum, officiis unde commodi itaque nemo deserunt ducimus.Similique deleniti illum sint sunt rem dolores iure fugit excepturi architecto veritatis, accusantium nisi omnis ipsam, neque commodi dolor soluta natus totam maxime at laboriosam provident, magnam nisi praesentium distinctio tempora.Sit reprehenderit odio assumenda obcaecati quia recusandae rem, aliquid hic facere ut voluptate fugit, excepturi nesciunt inventore obcaecati, voluptas itaque officia esse nulla laboriosam dolorum, doloribus veniam deserunt perspiciatis cumque dolorum?Dicta expedita soluta dolor est possimus nam magni debitis rem iusto, porro quo in consequuntur error ipsum, veritatis doloribus est, inventore porro ipsam unde quibusdam exercitationem voluptates.Officia cum ullam amet qui quos asperiores iusto, velit
