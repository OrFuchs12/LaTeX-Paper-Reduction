...
%For certain NLP tasks people propose to use attention mechanism on top of the LSTM model to introduce extra source of information to guide the extraction of global sequence embedding \cite{tan2015lstm,hermann2015teaching}. However, for other applications such as listwise context modeling considered in this paper, this approach is not directly applicable since the model is only given the list itself as input, and no such extra information is available.
...
\begin{table*}[tb]
	...
	%	& NDCG@50 & *0.7636   & 0.7548 & \underline{0.7579} & 0.7456 & 0.75\% & 6.89\%\\\hline
	\end{tabular}
...
\begin{table*}[tb]
	...
	%	& NDCG@50 & *0.7636   & 0.7605 & 0.7632 & 0.7613  \\\hline
	\end{tabular}
...
%There are several major research directions that we wish to extend the present work. Firstly, instead of relying on handcrafted features, a couple of neural networks models have been proposed to extract high-level features from raw unstructured data to predict the relevance of items, it is interesting to study how to eliminate the   . detrimental influence of inter-query variability in these models. Secondly, it is worthwhile to study the  \cite{shankar2018generalizing,rebuffi2018efficient,li2018learning}
