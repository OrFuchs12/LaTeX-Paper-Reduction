...
\centering
\begin{subfigure}{0.24\textwidth}
\includegraphics[width=\textwidth,height=1.089in ]{"./images/percentage_of_low_rank_group_for_num_of_winners_with_phi_new_new.png"}
...
\hfill
\begin{subfigure}{0.24\textwidth}
\includegraphics[width=\textwidth,height=0.99in ]{"./images/size_of_high_rank_group_for_num_of_reviews_with_phi_new_new.png"}
