...
\begin{subfigure}[b]{0.62\columnwidth}
\centering
\includegraphics[width=0.792\columnwidth,height=0.6960000000000001in ]{gaitTransOpt_4.png}
\caption{}
\label{subfig:inputGait4}
\end{subfigure}
\begin{subfigure}[b]{0.62\columnwidth}
\centering
\includegraphics[width=0.792\columnwidth,height=0.6960000000000001in ]{gaitTransOpt_8.png}
\caption{}
