...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{bm}
\usepackage{dsfont} % for dstroke font, to have \mathds, instead of :\usepackage{bbm} % for mathbbm, which uses type-3 fonts
\usepackage{amssymb} % for mathbb

% some packages/classes define the following, so check:
\ifdefined\theorem
    \message{\string\theorem\space is already defined}
\else
    \newtheorem{theorem}{Theorem}
\fi
\ifdefined\lemma
    \message{\string\lemma\space is already defined}
\else
    \newtheorem{lemma}[theorem]{Lemma}
\fi
\ifdefined\corollary
    \message{\string\corollary\space is already defined}
\else
...
\newcommand{\Expp}[2]{{\mathbb E}_{#1}\left[{#2}\right]}
...
\newcommand{\normp}[1]{\left\Vert {#1} \right\Vert_p}
\newcommand{\normdot}[1]{\left\Vert {\cdot} \right\Vert_#1}
...
\newcommand{\ind}[1]{\mathds{1}\braces{#1}} % replace: \newcommand{\ind}[1]{\mathbbm{1}\braces{#1}} which used type-3 fonts
...
%--- provide \algref only if it is not defined (can't use renewcommand, since we don't know if including tex uses a package where \algref is defined or not)
\providecommand{\algref}[1]{Alg.~\ref{#1}} %\renewcommand{\algref}[1]{Alg.~\ref{#1}}
...
\newcommand{\bvxi}[1]{\bvx_{#1}}
\newcommand{\bvxii}{\bvxi_{i}}

%\newcommand{\vz}{\mathbf{z}}
\newcommand{\vzi}[1]{\vz_{#1}}
\newcommand{\vzii}{\vzi{i}}

\newcommand{\veta}{\mb{\eta}}
\newcommand{\vetai}[1]{\veta_{#1}}

\newcommand{\vb}{\mathbf{b}}
\newcommand{\vbi}[1]{\vb_{#1}}
\newcommand{\vbii}{\vbi{i}}
...
\newcommand{\hpi}[1]{\hat{p}_{#1}}
\newcommand{\hpii}{\hpi{i}}

\newcommand{\vp}{\mb{p}}
\newcommand{\vpi}[1]{\vp_{#1}}
\newcommand{\vpii}{\vpi{i}}

\newcommand{\vq}{\mb{q}}
\newcommand{\vqi}[1]{\vq_{#1}}
\newcommand{\vqii}{\vqi{i}}
...
\newcommand{\ik}[1]{\begin{center}\fbox{\parbox{3in}{{\textcolor{magenta}{IK: #1}}}}\end{center}}
