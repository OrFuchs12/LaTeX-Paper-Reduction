...
% Add additional packages here, but check % the list of disallowed packages
% (including, but not limited to
% authblk, caption, CJK, float, fullpage, geometry, % hyperref, layout, nameref, natbib, savetrees,
...
/Keywords (Anonymous, We are legion, Topic Modelling, Sentiment Analysis, Bot Detection, Twitter, Social Media, Cybercrime, Cybercriminal, Hacktivism)
}
%
% Section Numbers
