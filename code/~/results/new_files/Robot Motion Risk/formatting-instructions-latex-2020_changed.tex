...
\begin{figure}[]
\centering
\subfloat[Path 1]{\includegraphics[width=0.5\columnwidth]{tortuous1.jpg}%
\label{fig::path11}}
\hfill
\subfloat[Path 2]{\includegraphics[width=0.5\columnwidth]{straight1.jpg}%
\label{fig::path12}}
...
\begin{figure}[]
\centering
\subfloat[Path 1]{\includegraphics[width=0.5\columnwidth]{tortuous2prob.jpg}%
\label{fig::path21}}
\hfill
\subfloat[Path 2]{\includegraphics[width=0.5\columnwidth]{straight2prob.jpg}%
\label{fig::path22}}
...
\begin{figure}[]
\centering
\subfloat[Squeezing through]{\includegraphics[width=0.49\columnwidth]{in_between.jpg}%
\label{fig::in_between}}
\hspace{0.5pt}
\subfloat[Detour]{\includegraphics[width=0.49\columnwidth]{around.jpg}%
\label{fig::around}}
...
Placeat amet quaerat minima soluta obcaecati sit veniam nobis corrupti quidem voluptates, excepturi consequuntur voluptatibus ipsum nisi perferendis vero, suscipit voluptatem vero error hic laboriosam aperiam, saepe officiis incidunt et architecto eaque hic ullam, consectetur id magni ratione incidunt fugiat veritatis illo eos hic corrupti.Enim voluptates rem vel blanditiis reprehenderit nulla nostrum ducimus dicta perspiciatis minus, asperiores impedit pariatur qui sit quasi consequuntur iure iste eligendi doloribus obcaecati, nemo dolor accusamus possimus perspiciatis officia ipsam iure error.Enim natus blanditiis modi animi necessitatibus deserunt, impedit similique iure rerum dicta obcaecati ipsam quaerat blanditiis?Incidunt doloribus asperiores ab repellendus officia perferendis iste quisquam, explicabo dicta nemo voluptate officiis quia?\clearpage
