...
% BOWLING's LATEX MAGIC
%---------------------------------
% More reasonable float placement.
...
\ifspacetight
   ...
   % Compresses space between figures and their captions
   % \abovecaptionskip3pt
   % --- BELOW THIS LINE ARE STARTING TO CHEAT THE STYLE GUIDELINES ---
   % Compresses space between the captions and the text.
   \if0
   \belowcaptionskip0pt
   \textfloatsep10pt plus0pt minus5pt
   \fi
   % Compresses space between displaymath and text.
   \if0
   \let\oldnormalsize\normalsize
   \def\normalsize{\oldnormalsize%
     \abovedisplayskip3pt plus2pt minus 2pt%
     \belowdisplayskip3pt plus2pt minus 2pt}
   \fi
\else
   \def\ssum{\sum}
   %\SetAlgoSkip{medskip}
