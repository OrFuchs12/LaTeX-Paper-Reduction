...
/Author (Yi-Chen Chen, Shang-Fu Chen, Chih-Kuan Yeh, Yu-Chiang Frank Wang)}
...
%%%%%%%Intro to CNN -- but often used in single-label
...
%%%%%%%%Current development in CNN+multi-label, best :CNN-RNN
...
%%%%%%%%Problem in current CNN-RNN
%Should not pre-define order of label
%Problem of apply pre-trained CNN: imbalanced importance of class in image
...
%%%%%Solution of these three problem (HOW TO CALL THEM?)
...
%How could you learn the order? %define name of your method
%attention layer: any contribution in combine it in this structure? Has such concept been used in other multi-task work? contribution: joint learn label and attention
...
% of sizes 14 x 14 x 512 for images of size 224 x 224.
\begin{equation}
\label{eq:feats}
\begin{aligned}
\V = [\V_{feat}, \v_{prob}]
...
%We also use doubly stochastic attention technique to enhance our result as~\cite{xu2015show} did. 
...
\begin{table}[]
	...
	\begin{tabular}{l||lll|lll}
        ...
        % Ours(w/o soft) & $71.3$ & $54.8$ & $61.8$ & $74.0$ & $61.8$ & $67.4$ \\
