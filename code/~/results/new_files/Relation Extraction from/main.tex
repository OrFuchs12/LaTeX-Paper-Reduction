...
%\begin{figure}[H]
%\centering
%\includegraphics[width=8.5cm, height=4cm]{figs/prompt.png}
%\hfill
%\caption{Prompt}
%\end{figure}
...
%quantitative evaluation.. if available

\section{User Interface}
% \begin{figure}[h]
% \centering
% \includegraphics[width=0.5\textwidth]{figs/renawebsite.png}
% \caption{RENA Interface}
% \end{figure}
...
%However, automatically extracting meaningful information from such a large array of unstructured text presents challenges with many limitations in algorithms and dealing with the nuances in the English language. In addition,  With the advent of machine learning and large language models (LLMs), these tasks have become significantly easier and more accurate.

% is just one of the many automation tasks. In particular, it is focused on the extraction of semantic relations in news articles at the document level with the use of LLMs. It is run on the browser where users can input any unstructured text from an article to generate a structured list of relations.