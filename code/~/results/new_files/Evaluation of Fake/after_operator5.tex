...
\includegraphics[width=\textwidth,height=0.97in ]{imgs/covid50.png}
\label{fig:e2}
\end{subfigure}
...
\textbf{Application Aspects} Automatic fake news detection in practice adds two dynamic application aspects, which are difficult to test with static datasets as our experiment on \texttt{COVID-19} has shown:
