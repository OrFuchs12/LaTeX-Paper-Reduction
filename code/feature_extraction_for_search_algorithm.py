...
def run_feature_extraction(latex_path, pdf_path, bib_path
                        , name, df):
...
def run_from_outside(latex_path, pdf_path, bib_path,
                     path_to_save_analysis_dict, name, df):
    try:

        df = run_feature_extraction(latex_path, pdf_path, bib_path,
                                    name, df)
        return df
